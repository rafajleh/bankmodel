...
[https://production-url.com](https://production-url.com)

<h2>Project Screenshots:</h2>

<img src="https://mkwebdev.onrender.com/images/Digital Bank.webp" alt="project-screenshot" width="100%" height="100%/">
...
That's it! Follow these steps to create the first owner of your Digital Bank platform using the ```api/admins/owner/create``` route.
...
const API_URL =
  process.env.NODE_ENV === "production"
    ? "https://production-url.com/api/account/"
